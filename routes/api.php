...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::group(['prefix' => 'filter', 'as' => 'filter.'], function () {
        Route::get('/{govrn_id}',[ServiceController::class, 'filter'])->name('filter');
        Route::get('/{govrn_id}/{region_id}',[ServiceController::class, 'filtergovernmentRegion'])->name('filtergovernmentRegion');
    });
